...
<script type="text/javascript">
    $(function () {
        ...
        $('#cityComboId').change(function () {
            getDistrictListByCityIdAdd($(this).val());
        });
    });
</script>
...
<div class="lblDesign"><label for="roomNrId">Room N#:</label></div><input type="number" min="0" class="lblInput" id="roomNrId" placeholder="Enter room number" required> <br>
